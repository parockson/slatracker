...
Implements 10% Relative Tolerance Logic: |Actual - Target| <= (Target * 0.10)
"""
...
def run_sla_audit(sales_df, sla_dict):
    """Core Audit Function with 10% Relative Tolerance."""
    ...
    for segment in ['Corporate', 'Retail', 'SMB']:
        ...
        def check_status(row):
            ...
            # Use epsilon (0.0001) for float precision safety
...
def get_filtered_raw(sales_df, audit_results, status_filter):
    """Filters raw CSV rows matching 'Pass', 'Fail', or 'No Target'."""
